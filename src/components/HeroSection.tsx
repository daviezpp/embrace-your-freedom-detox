...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-purple-dark/30 backdrop-blur-md z-10 flex flex-col items-center">
        <img src="/lovable-uploads/2f4d366e-bf85-46b0-be19-53216d65d766.png" alt="Logo Tornar-me Eu" className="w-24 h-auto mt-6 object-contain" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-20 text-center">
        ...
        duration: 0.8
          ...
          scale: 0.95
            ...
            <Button className="px-8 py-6 text-lg bg-gradient-to-r from-purple-light to-purple bg-size-200 animate-gradient-x" onClick={scrollToPricing}>
              Comece Agora
