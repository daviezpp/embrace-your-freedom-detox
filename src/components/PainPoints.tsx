  ...
  return (
    <section className="relative min-h-[80vh] overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 h-full">
        <div className="flex flex-col h-full justify-center py-20 md:py-24 max-w-2xl">
          <div 
            ref={contentRef} 
          ...
          >
            ...
            <div className="mb-10">
              <h2 className="text-4xl md:text-6xl lg:text-7xl font-playfair font-bold text-white mb-4 leading-tight drop-shadow-md">
                Você sabe que <span className="text-nude-light italic">precisa sair...</span>
              </h2>
              <h3 className="text-xl md:text-3xl font-playfair italic text-nude-light drop-shadow-sm">
                mas algo te puxa de volta.
              </h3>
            </div>
            
            <div className="space-y-8 mb-12">
              <div className="bg-white/10 backdrop-blur-sm p-6 md:p-8 rounded-xl border border-white/20 shadow-xl transition-all duration-300 hover:bg-white/15">
              ...
              <div className="flex items-start gap-5 bg-white/15 backdrop-blur-md p-6 md:p-8 rounded-xl border border-white/20 shadow-xl transform transition-all hover:translate-y-[-5px] hover:bg-white/20">
                <HandHeart className="text-nude-light w-8 h-8 mt-1 flex-shrink-0" strokeWidth={1.5} />
                <p className="text-lg md:text-xl text-white leading-relaxed">
                  ...
                  <span className="block mt-3 font-semibold text-nude-light">Apenas você, por você.</span>
                </p>
              </div>
            </div>
      ...
      {/* Decorative elements */}
      <div className="absolute top-[20%] right-[15%] w-24 h-24 rounded-full bg-purple-light/20 blur-2xl animate-pulse z-0"></div>
      <div className="absolute bottom-[30%] right-[25%] w-32 h-32 rounded-full bg-purple-light/10 blur-2xl animate-pulse z-0" style={{ animationDelay: '1.5s' }}></div>
    </section>
  );
};
