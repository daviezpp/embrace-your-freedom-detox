          ...
          duration: 0.5
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden border border-purple/20 transform hover:shadow-purple/20 hover:shadow-xl transition-all duration-500">
              ...
              duration: 0.3
                ...
                {/* Payment methods - Updated based on the reference image */}
                <motion.div 
                  ...
                  <div className="flex items-center justify-center gap-3 py-2 px-3 bg-gray-800/80 rounded-lg">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 780 500" className="w-8 h-5">
                      ...
                      <path d="M518.1,158.3c-10.6-4-27.1-8.2-47.8-8.2c-52.7,0-89.8,26.5-90,64.6c-0.2,28.1,26.5,43.8,46.7,53.2
                        ...
                        c0-8,9.6-16.6,30.3-16.6c17.3-0.3,29.9,3.5,39.6,7.4l4.8,2.2L518.1,158.3" fill="#9CA3AF"/>
                      <path d="M615.5,153L577.4,284c-0.9,4.3-4.6,7.1-7.1,7.1h-61.6l-3.3-11.2c0,0,6.4-11.1,18.3-27.1
                        ...
                        c0.1,0.2-0.1-0.3,0,0l0.9,35.6L615.5,153z" fill="#9CA3AF"/>
                      <path d="M146.7,153h73.4l-14.9,87.3l65.3-87.3h50.1c14.1,0,18.9,4.9,22.4,16l16.3,86.1l15.6-102.1h52.6L389.9,348.7
                        h-49.9l-22.3-115.5l-41.8,115.5h-49.4l1-14l-8.8,14h-79.7L146.7,153z" fill="#9CA3AF"/>
                    </svg>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 780 500" className="w-8 h-5">
                      ...
                      <path d="M615,320.7V309h8.9c2.1,0,4.3,0.4,4.3,3.6c0,3-2.3,3.5-4.3,3.5H615V320.7z M621.3,330.1l5.5-10h-4.5v-15.2h10.6
                        ...
                        h36.1v-17.7h-36.1V278h36.1v-17.7H551V288.7L551,288.7z" fill="#9CA3AF"/>
                    </svg>
                    
                    {/* Barcode/Boleto icon */}
                    <svg viewBox="0 0 24 24" className="w-6 h-6">
                      <path d="M2 4V18H4V20H6V18H8V20H10V18H12V20H14V18H16V20H18V18H20V20H22V18H24V4H2ZM4 8H6V16H4V8ZM8 8H10V16H8V8ZM12 8H14V16H12V8ZM16 8H18V16H16V8ZM20 8H22V16H20V8Z" fill="#9CA3AF" />
                    </svg>
                    
                    {/* ELO icon */}
                    <svg viewBox="0 0 160 100" className="w-8 h-5">
                      <path d="M45.5,35.9c-5.4,0-9.7,4.4-9.7,9.7c0,5.4,4.4,9.7,9.7,9.7c5.4,0,9.7-4.4,9.7-9.7C55.2,40.2,50.8,35.9,45.5,35.9z" fill="#9CA3AF"/>
                      <path d="M93.1,35.9c-5.4,0-9.7,4.4-9.7,9.7c0,5.4,4.4,9.7,9.7,9.7c5.4,0,9.7-4.4,9.7-9.7C102.8,40.2,98.5,35.9,93.1,35.9z" fill="#9CA3AF"/>
                      <path d="M69.3,48.6c-1.7,0-3.1,1.4-3.1,3.1c0,1.7,1.4,3.1,3.1,3.1c1.7,0,3.1-1.4,3.1-3.1C72.4,50,71,48.6,69.3,48.6z" fill="#9CA3AF"/>
                      <path d="M79,42.4c-1.7,0-3.1,1.4-3.1,3.1c0,1.7,1.4,3.1,3.1,3.1c1.7,0,3.1-1.4,3.1-3.1C82.1,43.8,80.7,42.4,79,42.4z" fill="#9CA3AF"/>
                      <path d="M69.3,36.2c-1.7,0-3.1,1.4-3.1,3.1c0,1.7,1.4,3.1,3.1,3.1c1.7,0,3.1-1.4,3.1-3.1C72.4,37.6,71,36.2,69.3,36.2z" fill="#9CA3AF"/>
                      <path d="M60,42.4c-1.7,0-3.1,1.4-3.1,3.1c0,1.7,1.4,3.1,3.1,3.1c1.7,0,3.1-1.4,3.1-3.1C63.1,43.8,61.7,42.4,60,42.4z" fill="#9CA3AF"/>
                    </svg>

                    {/* Hipercard icon simplified version */}
                    <svg viewBox="0 0 60 40" className="w-8 h-5">
                      <rect x="5" y="10" width="50" height="20" rx="3" fill="transparent" stroke="#9CA3AF" stroke-width="2"/>
                      <path d="M15 20L45 20" stroke="#9CA3AF" stroke-width="2"/>
                    </svg>
                    
                    {/* Mastercard icon */}
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 780 500" className="w-8 h-5">
                      <path d="M490,250c0,99.4-80.6,180-180,180s-180-80.6-180-180s80.6-180,180-180S490,150.6,490,250z" fill="#9CA3AF"/>
                      <path d="M470,250c0,99.4-80.6,180-180,180s-180-80.6-180-180s80.6-180,180-180S470,150.6,470,250z" fill="#9CA3AF" fill-opacity="0.7"/>
                      <path d="M310,250c0,55.2,44.8,100,100,100s100-44.8,100-100s-44.8-100-100-100S310,194.8,310,250z" fill="#9CA3AF" fill-opacity="0.8"/>
                    </svg>
                  </div>
                </motion.div>
